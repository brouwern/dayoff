---
title: "h01) Comparative Genomics"
...
```{r}
ensemblprotists <- useMart("protist_mart_9") 
```
...
You will see a long list of the organisms for which the Ensembl Protists database has genome data, including Plasmodium vivax and Plasmodium falciparium (which cause malaria), and Leishmania major, which causes leishmaniasis, which is classified by the WHO as a neglected tropical disease.
...
Find the length of vector "attributenames"
```{r}
...
1. How many Mycobacterium ulcerans protein-coding genes have Mycobacterium leprae orthologues? Note: *Mycobacterium leprae* is the bacterium that causes leprosy, which is classified by the WHO as a neglected tropical disease.
1. How many of the*Mycobacterium ulcerans* protein-coding genes have one-to-one orthologues in Mycobacterium leprae?
...
1. How many of copies are there in the *Mycobacterium lepraae* protein set, of each of the top 5 Mycobacterium ulcerans Pfam protein domains?
1. Are the numbers of copies of some domains different in the two species?
1. Of the differences found in Q9, are any of the differencess statistically significant?
